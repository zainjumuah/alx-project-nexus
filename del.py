...
class CategoryAPITests(TestCase):
    ...
    def test_anonymous_update_delete_category_blocked(self):
        cat = Category.objects.create(**self._unique_payload())
        ...
        delete_res = self.client.delete(self._categories_detail_url(cat.id))
        self.assertIn(delete_res.status_code, (status.HTTP_401_UNAUTHORIZED, status.HTTP_403_FORBIDDEN))

    def test_auth_create_category_201_and_persists(self):
        self._auth_as()
        payload = self._unique_payload()
        res = self.client.post(self._categories_list_url(), payload, format="json")
    ...
    def test_auth_delete_204_and_get_after_delete_404(self):
        ...
        del_res = self.client.delete(self._categories_detail_url(cat.id))
    ...
    def test_auth_create_duplicate_slug_fails(self):
        ...
        self.client.post(self._categories_list_url(), payload, format="json")
